    ...
    for i, layer in enumerate(model.layer):
        if layer.type == 'Convolution': # or layer.type == 'Scale':
            ...
            if layer.convolution_param.bias_term == False:
				layer.param.add()
				layer.param[1].name = str(layer.name).split('_')[0] + '_b'
				layer.param[1].lr_mult = 2
				layer.param[1].decay_mult = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m','--model', type=str, help="The net definition prototxt", default='/home/ctg-sa/jazz_ws/caffe/examples/pedestrian_siamese/siameseFC3/siamese_pd_deploy.prototxt')
    parser.add_argument('-w', '--weights', type=str, help="The weights caffemodel", default='/home/ctg-sa/jazz_ws/caffe/examples/pedestrian_siamese/siameseFC3/siameseFC3_pd_iter_15000.caffemodel')
    parser.add_argument('-om', '--output_model', type=str, default='/home/ctg-sa/jazz_ws/caffe/examples/pedestrian_siamese/siameseFC4/siamese_pd_deploy.prototxt')
    parser.add_argument('-ow', '--output_weights', type=str, default='/home/ctg-sa/jazz_ws/caffe/examples/pedestrian_siamese/siameseFC4/siamese_pd_deploy.caffemodel')
